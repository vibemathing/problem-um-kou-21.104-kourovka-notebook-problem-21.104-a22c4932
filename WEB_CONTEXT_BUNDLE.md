...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-kou-21.104-kourovka-notebook-problem-21.104-a22c4932-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/KOU-21.104"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-kou-21.104-kourovka-notebook-problem-21.104-a22c4932-v1",
      "problem_contract_sha256": "8b57dcf26f1b5b70612a399435d9683282e60ab2f1c8ae2a249358aa68833e94",
      "problem_id": "problem:um-kou-21.104-kourovka-notebook-problem-21.104-a22c4932",
      "route_id": "route:um-kou-21.104-kourovka-notebook-problem-21.104-a22c4932-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-kou-21.104-kourovka-notebook-problem-21.104-a22c4932-source-fidelity-01",
      "graph_id": "graph:um-kou-21.104-kourovka-notebook-problem-21.104-a22c4932-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-kou-21.104-kourovka-notebook-problem-21.104-a22c4932-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-kou-21.104-kourovka-notebook-problem-21.104-a22c4932-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "For a group word $w(x_1,\\ldots,x_n)$ on $n$ letters, define $e_0(x_1,\\ldots,x_n)=x_1$ and $e_{k+1}(x_1,\\ldots,x_n)=w(e_k(x_1,\\ldots,x_n),\\ldots,x_n)$ for all $k\\in\\mathbb N$. A group $G$ is said to satisfy the Engel type iterated identity $w$ if for all $x_1,\\ldots,x_n\\in G$ there exists $m\\in\\mathbb N$ such that $e_m(x_1,\\ldots,x_n)=1$. Conjecture: For every non-trivial word $w$, if a finitely generated branch group $G$ (see 15.12) satisfies the iterated identity $w$, then $G$ is a torsion group."
          },
          "statement_sha256": "a0b9294cd7d7f36f7fd1c2489f60e8e37bd07ef0393bdf927af8e8a903f3fdd3"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-kou-21.104-kourovka-notebook-problem-21.104-a22c4932-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-kou-21.104-kourovka-notebook-problem-21.104-a22c4932-root",
      "route_id": "route:um-kou-21.104-kourovka-notebook-problem-21.104-a22c4932-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-kou-21.104-4f9c8cc3f582",
        "url": "https://www.unsolvedmath.com/problems/KOU-21.104"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
